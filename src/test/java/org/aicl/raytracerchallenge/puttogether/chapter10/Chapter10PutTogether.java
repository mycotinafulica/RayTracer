package org.aicl.raytracerchallenge.puttogether.chapter10;
...
public class Chapter10PutTogether {
    ...
    public void letsPutTogether() throws IOException {
        ...
        wall.getMaterial().pattern = new GradientPattern(new Color(1, 0, 0), new Color(0, 0, 1));
        wall.getMaterial().pattern.setTransform(generator.rotateY(Math.PI/2.0));
...
//        m.pattern = new GradientPattern(new Color(1, 0, 0), new Color(0, 0, 1));
//        m.pattern.setTransform(generator.scale(2, 2, 2));
        middle.setMaterial(m);
        middle.getMaterial().color = new Color(0.2, 0.6, 0.8);
...
//        world.addObject(right);
        ...
        Camera camera = new Camera(100, 50, Math.PI/3.0);
        ...
        c.writeToPpmFile("E:\\William\\HighImportance\\GIT_ROOT\\RayTracerChallenge\\RayTracerChallenge\\test\\put_together_chapter10.ppm");
    }
}
